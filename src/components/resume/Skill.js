...
export default function Education() {
  return (
    <>
      <Title>Skill</Title>
      <h4 className='text-xl flex items-center mt-4 mb-1'>
      ...
      <div className='ml-4'>
        ...
        <ul className='pl-4'>
          <li className='flex items-end mb-2'>
            <div className='border-solid border-0 border-b border-gray-300 text-gray-500 w-36'>7 Year</div>
            <div className='flex'>
          ...
          <li className='flex items-end'>
            <div className='border-solid border-0 border-b border-gray-300 text-gray-500 w-36'>6 Year</div>
            <div className='flex'>
        ...
        <ul className='pl-4'>
          <li className='flex items-end mb-2'>
            <div className='border-solid border-0 border-b border-gray-300 text-gray-500 w-36'>Server side, API</div>
            <div className='flex'>
          ...
          <li className='flex items-end mb-2'>
            <div className='border-solid border-0 border-b border-gray-300 text-gray-500 w-36'>CSS Framework</div>
          ...
          <li className='flex items-end mb-2'>
            <div className='border-solid border-0 border-b border-gray-300 text-gray-500 w-36'>Build Tools</div>
            <div className='flex'>
          ...
          <li className='flex items-end mb-2'>
            <div className='border-solid border-0 border-b border-gray-300 text-gray-500 w-36'>Mobile</div>
            <div className='flex'>
              <TagSkill icon={<SiFlutter />} name='Flutter' />
            </div>
          </li>
          <li className='flex items-end mb-2'>
            <div className='border-solid border-0 border-b border-gray-300 text-gray-500 w-36'>CSS in JavaScript</div>
            <div className='flex'>
