    ...
    <>
      ...
      <ul className='p-2' style={{listStyle: 'none'}}>
        <li className={`${styles['list-due']} pb-5`}>
          ...
          <a href='https://sandbox-document.ants.vn/components#/document' target='_blank' rel='noreferrer'>
        ...
        <li className={`${styles['list-due']} pb-5`}>
          ...
          <span>
            We provide plenty of UI components to enrich your web applications, and we will improve the component's
            experience.
          </span>
        </li>
        <li className={`${styles['list-due']}`}>
          ...
          <ul>
            <li>ReactJS, Redux, Typescript, Webpack</li>
          </ul>
        </li>
        <li className={`${styles['list-due']}`}>
          <GoPrimitiveDot className='text-[19px] absolute left-0 text-[#4e4e4e]' />
      ...
      <ul className='p-2' style={{listStyle: 'none'}}>
        <li className={`${styles['list-due']} pb-5`}>
          <GoPrimitiveDot className='text-[19px] absolute left-0 text-[#4e4e4e]' />
          <h4 className='mb-2'>Link</h4>
          <a href='https://ta-blog.vercel.app/resume' target='_blank' rel='noreferrer'>
            TA Blog
          </a>
        </li>
        <li className={`${styles['list-due']} pb-5`}>
        ...
        <li className={`${styles['list-due']}`}>
          ...
          <h4 className='mb-2'>Tech stack</h4>
          <ul>
            <li>Docusaurus, ReactJS, TailwindCSS, Markdown</li>
          </ul>
        </li>
        <li className={`${styles['list-due']}`}>
          <GoPrimitiveDot className='text-[19px] absolute left-0 text-[#4e4e4e]' />
      ...
      <ul className='p-2' style={{listStyle: 'none'}}>
        <li className={`${styles['list-due']}`}>
          <GoPrimitiveDot className='text-[19px] absolute left-0 text-[#4e4e4e]' />
          <h4 className='mb-2'>Link</h4>
          <a href='https://github.com/TAdev07' target='_blank' rel='noreferrer'>
            Github
          </a>
        </li>
      </ul>
